...
def _save_task_to_db(db_task,data,job_id):
    job = rq.get_current_job()
    ...
    print("jobid-->",job_id)
    root_path='/home/django/data/data/{}/raw/{}'.format(job_id,source)
    command1='strings {} | grep GNRMC>/home/django/data/data/{}/{}.csv'.format(root_path,job_id,job_id)
...
def _create_thread(tid, data):
    ...
    _save_task_to_db(db_task,data,jobid)
